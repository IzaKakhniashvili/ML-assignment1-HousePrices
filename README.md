...
- **ანალიზი:** შედარებით მაღალი RMSE. feature engineering გარეშე model-ი ვერ ხვდება ბევრ ბუნებრივ კავშირს (მაგ. ფართი × ხარისხი). ასევე data leakage imputation-ში.
...
- **ანალიზი:** Ridge L2 regularization-ი ახდენს ყველა coefficient-ის შეკუმშვას (არ ნულავებს). ეს overfitting-ს ამცირებს მაშინ, როდესაც ბევრი feature გვაქვს. CV ავტომატურად ირჩევს alpha-ს.
